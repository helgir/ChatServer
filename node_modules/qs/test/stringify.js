...
var str_identities = {
    ...
    'nested': [{
        ...
        str: 'foo=bar&baz[0]=1&baz[1]=2&baz[2]=3',
        obj: {
            'foo': 'bar',
            'baz': ['1', '2', '3']
        }
    }, {
        str: 'foo[0]=bar&baz[0]=1&baz[1]=2&baz[2]=3',
        obj: {
            'foo': ['bar'],
            'baz': ['1', '2', '3']
        }
    ...
    'numbers': [{
        str: 'limit[0]=1&limit[1]=2&limit[2]=3',
        obj: {
            limit: [1, 2, '3']
        }
    }, {
    ...
    'others': [{
        str: 'at=' + encodeURIComponent(date),
        obj: {
            at: date
        }
    }]
