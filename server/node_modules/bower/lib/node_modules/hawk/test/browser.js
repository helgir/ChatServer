...
describe('Browser', function() {
    ...
    it('generates a header then successfully parse it (node request)', function(done) {
        ...
        credentialsFunc('123456', function(err, credentials1) {
            ...
            Hawk.server.authenticate(req, credentialsFunc, {}, function(err, credentials2, artifacts) {
                ...
                expect(Browser.client.authenticate(res, credentials2, artifacts, {
                    payload: 'some reply'
                })).to.equal(true);
                done();
            });
    ...
    it('generates a header then successfully parse it (time offset)', function(done) {
        ...
        credentialsFunc('123456', function(err, credentials1) {
            ...
            Hawk.server.authenticate(req, credentialsFunc, {
                localtimeOffsetMsec: 100000
            }, function(err, credentials2, artifacts) {
        ...
        describe('message()', function() {
            ...
            it('errors on missing host', function(done) {
                ...
                credentialsFunc('123456', function(err, credentials) {
                    ...
                    var auth = Browser.client.message(null, 8080, 'some message', {
                        credentials: credentials
                    });
            ...
            it('errors on invalid host', function(done) {
                ...
                credentialsFunc('123456', function(err, credentials) {
                    ...
                    var auth = Browser.client.message(5, 8080, 'some message', {
                        credentials: credentials
                    });
                    expect(auth).to.not.exist();
                    done();
            ...
            it('errors on missing port', function(done) {
                ...
                credentialsFunc('123456', function(err, credentials) {
                    ...
                    var auth = Browser.client.message('example.com', 0, 'some message', {
                        credentials: credentials
                    });
                    expect(auth).to.not.exist();
                    done();
            ...
            it('errors on invalid port', function(done) {
                ...
                credentialsFunc('123456', function(err, credentials) {
                    ...
                    var auth = Browser.client.message('example.com', 'a', 'some message', {
                        credentials: credentials
                    });
                    expect(auth).to.not.exist();
                    done();
            ...
            it('errors on missing message', function(done) {
                ...
                credentialsFunc('123456', function(err, credentials) {
                    ...
                    var auth = Browser.client.message('example.com', 8080, undefined, {
                        credentials: credentials
                    });
                    expect(auth).to.not.exist();
                    done();
            ...
            it('errors on null message', function(done) {
                ...
                credentialsFunc('123456', function(err, credentials) {
                    ...
                    var auth = Browser.client.message('example.com', 8080, null, {
                        credentials: credentials
                    });
                    expect(auth).to.not.exist();
                    done();
            ...
            it('errors on invalid message', function(done) {
                ...
                credentialsFunc('123456', function(err, credentials) {
                    ...
                    var auth = Browser.client.message('example.com', 8080, 5, {
                        credentials: credentials
                    });
                    expect(auth).to.not.exist();
                    done();
    ...
    describe('utils', function() {
        ...
        describe('setNtpOffset()', function(done) {
            ...
            it('catches localStorage errors', {
                parallel: false
            }, function(done) {
