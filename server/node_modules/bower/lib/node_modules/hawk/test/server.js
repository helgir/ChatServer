...
describe('Server', function() {
    ...
    describe('authenticate()', function() {
        ...
        it('errors on credentialsFunc error', function(done) {
            ...
            Hawk.server.authenticate(req, credentialsFuncion, {
                localtimeOffsetMsec: 1353788437000 - Hawk.utils.now()
            }, function(err, credentials, artifacts) {
    ...
    describe('authenticateMessage()', function() {
        ...
        it('should fail on missing host', function(done) {
            ...
            credentialsFunc('123456', function(err, credentials) {
                ...
                var auth = Hawk.client.message(null, 8080, 'some message', {
    ...
    describe('authenticatePayloadHash()', function() {
        ...
        it('checks payload hash', function(done) {
            ...
            expect(Hawk.server.authenticatePayloadHash('abcdefg', {
                hash: 'abcdefg'
            })).to.equal(true);
            expect(Hawk.server.authenticatePayloadHash('1234567', {
                hash: 'abcdefg'
            })).to.equal(false);
            done();
        });
