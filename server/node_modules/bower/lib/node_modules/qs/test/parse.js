...
describe('parse()', function() {
    ...
    it('parses a mix of simple and explicit arrays', function(done) {
        ...
        expect(Qs.parse('a[0]=b&a=c')).to.deep.equal({
            a: ['b', 'c']
        });
        expect(Qs.parse('a=b&a[0]=c')).to.deep.equal({
            a: ['b', 'c']
        });
        expect(Qs.parse('a[1]=b&a=c')).to.deep.equal({
            a: ['b', 'c']
        });
        expect(Qs.parse('a=b&a[1]=c')).to.deep.equal({
            a: ['b', 'c']
        });
        done();
    });
    ...
    it('supports keys that begin with a number', function(done) {
        ...
        expect(Qs.parse('a[12b]=c')).to.deep.equal({
            a: {
                '12b': 'c'
            }
        });
    ...
    it('transforms arrays to objects (dot notation)', function(done) {
        ...
        expect(Qs.parse('foo[0].baz=bar&fool.bad=baz', {
            allowDots: true
        })).to.deep.equal({
            foo: [{
                baz: 'bar'
        ...
        expect(Qs.parse('foo[0].baz=bar&fool.bad.boo=baz', {
            allowDots: true
        })).to.deep.equal({
            foo: [{
                baz: 'bar'
        ...
        expect(Qs.parse('foo[0][0].baz=bar&fool.bad=baz', {
            allowDots: true
        })).to.deep.equal({
            foo: [
                [{
        ...
        expect(Qs.parse('foo[0].baz[0]=15&foo[0].bar=2', {
            allowDots: true
        })).to.deep.equal({
            foo: [{
                baz: ['15'],
        ...
        expect(Qs.parse('foo[0].baz[0]=15&foo[0].baz[1]=16&foo[0].bar=2', {
            allowDots: true
        })).to.deep.equal({
            foo: [{
                baz: ['15', '16'],
        ...
        expect(Qs.parse('foo.bad=baz&foo[0]=bar', {
            allowDots: true
        })).to.deep.equal({
            foo: {
                bad: 'baz',
        ...
        expect(Qs.parse('foo.bad=baz&foo[]=bar', {
            allowDots: true
        })).to.deep.equal({
            foo: {
                bad: 'baz',
        ...
        expect(Qs.parse('foo[]=bar&foo.bad=baz', {
            allowDots: true
        })).to.deep.equal({
            foo: {
                '0': 'bar',
        ...
        expect(Qs.parse('foo.bad=baz&foo[]=bar&foo[]=foo', {
            allowDots: true
        })).to.deep.equal({
            foo: {
                bad: 'baz',
        ...
        expect(Qs.parse('foo[0].a=a&foo[0].b=b&foo[1].a=aa&foo[1].b=bb', {
            allowDots: true
        })).to.deep.equal({
            foo: [{
                a: 'a',
    ...
    it('allows for empty strings in arrays', function(done) {
        ...
        expect(Qs.parse('a[]=&a[]=b&a[]=c')).to.deep.equal({
            a: ['', 'b', 'c']
        });
        done();
    });
    ...
    it('parses plain objects correctly', function(done) {
        ...
        expect(Qs.parse(a)).to.deep.equal({
            b: 'c'
        });
        var result = Qs.parse({
            a: a
    ...
    it('can allow overwriting prototype properties', function(done) {
        ...
        expect(Qs.parse('a[hasOwnProperty]=b', {
        ...
        expect(Qs.parse('hasOwnProperty=b', {
            allowPrototypes: true
        })).to.deep.equal({
            hasOwnProperty: 'b'
        }, {
    ...
    it('can return plain objects', function(done) {
        ...
        expect(Qs.parse('a[b]=c&a[hasOwnProperty]=d', {
            plainObjects: true
        })).to.deep.equal(expected);
        expect(Qs.parse(null, {
            plainObjects: true
        })).to.deep.equal(Object.create(null));
        var expectedArray = Object.create(null);
        expectedArray.a = Object.create(null);
        expectedArray.a['0'] = 'b';
        expectedArray.a.c = 'd';
        expect(Qs.parse('a[]=b&a[c]=d', {
            plainObjects: true
