...
exports.deepCircular = function() {
    ...
    assert.ok(!traverse.deepEqual(a, b),
...
exports.deepInstances = function() {
    assert.ok(!traverse.deepEqual([new Boolean(false)], [false]),
        'boolean instances are not real booleans'
    );

    assert.ok(!traverse.deepEqual([new String('x')], ['x']),
        'string instances are not real strings'
    );

    assert.ok(!traverse.deepEqual([new Number(4)], [4]),
    ...
    assert.ok(!traverse.deepEqual([new RegExp(/./)], [/../]),
...
exports.falsy = function() {
    ...
    assert.ok(!traverse.deepEqual([null], [undefined]),
...
exports.deletedArrayEqual = function() {
    ...
    assert.ok(!traverse.deepEqual(xs, [1, 2, undefined, 4]),
        'deleted array elements cannot be undefined'
    );

    assert.ok(!traverse.deepEqual(xs, [1, 2, null, 4]),
