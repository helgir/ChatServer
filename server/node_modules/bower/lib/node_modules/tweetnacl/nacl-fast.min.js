! function(r) {
    ...
    function s(r, t, n, e, o, i, h) {
        ...
        if (o > 0)
            for (a(c, u, h, cr), s = 0; o > s; s++) r[t + s] = n[e + s] ^ c[s];
        return 0
    }
    ...
    function u(r, t, n, e, o) {
        ...
        if (n > 0)
            for (a(s, f, o, cr), h = 0; n > h; h++) r[t + h] = s[h];
        return 0
    }
    ...
    function I(r, t, n) {
        var e, o;
        for (v(r[0], er), v(r[1], or), v(r[2], or), v(r[3], er), o = 255; o >= 0; --o) e = n[o / 8 | 0] >> (7 & o) & 1, N(r, t, e), O(t, r), O(r, r), N(r, t, e)
    }
    ...
    function Z(r, t) {
        var n, e, o, i;
        for (e = 63; e >= 32; --e) {
            for (n = 0, o = e - 32, i = e - 12; i > o; ++o) t[o] += n - 16 * t[e] * gr[o - (e - 32)], n = t[o] + 128 >> 8, t[o] -= 256 * n;
            t[o] += n, t[e] = 0
        }
        for (n = 0, o = 0; 32 > o; o++) t[o] += n - (t[31] >> 4) * gr[o], n = t[o] >> 8, t[o] &= 255;
        for (o = 0; 32 > o; o++) t[o] -= n * gr[o];
    ...
    function H(r, t) {
        if (r.length !== vr) throw new Error("bad key size");
        if (t.length !== br) throw new Error("bad nonce size")
    }
    ...
    r.lowlevel = {
            ...
            var t, n = unescape(encodeURIComponent(r)),
