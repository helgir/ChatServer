...
var base = [
    'io.js', 'util.js', 'events.js', 'json.js', 'parser.js', 'transport.js', 'socket.js', 'namespace.js'
];
...
var baseTransports = {
    ...
    'flashsocket': [
        'transports/websocket.js', 'transports/flashsocket.js', 'vendor/web-socket-js/swfobject.js', 'vendor/web-socket-js/web_socket.js'
    ],
    ...
    'jsonp-polling': [
        'transports/xhr.js', 'transports/xhr-polling.js', 'transports/jsonp-polling.js'
    ]
};
...
if (!module.parent) {
    ...
    builder(args.length ? args : false, {
        ...
        fs.write(
            fs.openSync(__dirname + '/../dist/socket.io.js', 'w'), content, 0, 'utf8'
        );
    ...
    builder(args.length ? args : false, function(err, content) {
        ...
        fs.write(
            fs.openSync(__dirname + '/../dist/socket.io.min.js', 'w'), content, 0, 'utf8'
        );
