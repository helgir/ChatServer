...
function instrument(code) {
    ...
    function do_cond(c, t, f) {
        return [this[0], w.walk(c), ["seq", trace(t), w.walk(t)],
    ...
    function do_binary(c, l, r) {
        ...
        return [this[0], c, ["seq", trace(l), w.walk(l)],
...
function test() {
    ...
    var k = plurp() ? 1 : 0;
    var x = a ? doX(y) && goZoo("zoo") : b ? blerg({
        x: y
    }) : null;
